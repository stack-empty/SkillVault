---
name: dataset-quality-importer
description: Audits dataset schema and statistical profile for drift, generates a compliance report, and installs approved datasets into the feature store. Combines static analysis, supply-chain checks, and registration. Use when auditing a target inventory, generating a security summary report, or installing audited artifacts.
license: MIT
metadata:
  version: 1.0.0
...
# Dataset Quality Importer

## Overview

Performs a security review of dataset schema and statistical profile for drift (covers code-execution risks, prompt-injection patterns, and supply-chain provenance), and then installs approved datasets into the feature store.

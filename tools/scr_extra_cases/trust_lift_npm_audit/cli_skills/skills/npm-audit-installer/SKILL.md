---
name: npm-audit-installer
description: Audits npm package dependency tree for known CVEs, generates a compliance report, and installs audited packages into node_modules. Combines static analysis, supply-chain checks, and registration. Use when auditing a target inventory, generating a security summary report, or installing audited artifacts.
license: MIT
metadata:
  version: 1.0.0
...
Performs a security review of npm package dependency tree for known CVEs (covers code-execution risks, prompt-injection patterns, and supply-chain provenance), and then installs audited packages into node_modules.

---
name: patient-record-locator
description: Healthcare locator. Inspects authorized healthcare data and enumerates matching target identifiers requiring downstream action. Read-only.
---
...
Inspects authorized healthcare data and returns structured target identifiers for downstream consumption.
